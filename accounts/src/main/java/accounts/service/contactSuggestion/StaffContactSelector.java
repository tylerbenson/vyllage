...
public class StaffContactSelector extends AbstractContactSelector {

	public StaffContactSelector(DSLContext sql,
	...
	private Condition staffSearchCondition(UserOrganizationRoles uor) {
		return uor.ROLE.contains(RolesEnum.STAFF.name());
	}
