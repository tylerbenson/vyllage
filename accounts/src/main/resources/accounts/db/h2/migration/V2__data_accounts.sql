...
insert into ACCOUNTS.account_settings(user_id, name, "value", privacy) values (0, 'emailUpdates', 'weekly', 'public');
insert into ACCOUNTS.account_settings(user_id, name, "value", privacy) values (0, 'firstName', null, 'public');
insert into ACCOUNTS.account_settings(user_id, name, "value", privacy) values (0, 'middleName', null, 'public');
insert into ACCOUNTS.account_settings(user_id, name, "value", privacy) values (0, 'lastName', null, 'private');
insert into ACCOUNTS.account_settings(user_id, name, "value", privacy) values (0, 'address', 'Avenida Siempreviva 123', 'public');
