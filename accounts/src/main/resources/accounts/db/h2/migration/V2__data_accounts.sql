...
insert into ACCOUNTS.users ( user_name, first_Name, last_name, enabled, date_created, last_modified ) values ( 'vytst@mailinator.com', 'Mailinator', 'Email', true, CURRENT_DATE(), CURRENT_DATE() );
...
-- dumy settings so they whow up, for users created through the app this is isn't a problem. 
insert into ACCOUNTS.account_setting(user_id, name, value, privacy) values (2, 'emailUpdates', 'weekly', 'public');
insert into ACCOUNTS.account_setting(user_id, name, value, privacy) values (3, 'emailUpdates', 'weekly', 'public');
insert into ACCOUNTS.account_setting(user_id, name, value, privacy) values (4, 'emailUpdates', 'weekly', 'public');
insert into ACCOUNTS.account_setting(user_id, name, value, privacy) values (5, 'emailUpdates', 'weekly', 'public');
insert into ACCOUNTS.account_setting(user_id, name, value, privacy) values (6, 'emailUpdates', 'weekly', 'public');
insert into ACCOUNTS.account_setting(user_id, name, value, privacy) values (7, 'emailUpdates', 'weekly', 'public');
insert into ACCOUNTS.account_setting(user_id, name, value, privacy) values (8, 'emailUpdates', 'weekly', 'public');
...
insert into ACCOUNTS.user_organization_roles ( organization_id, user_id, role, date_created, audit_user_id ) values ( 1, 8, 'STUDENT', CURRENT_DATE(), 0 );

--to test canvas login and account creation with existing user
insert into ACCOUNTS.users ( user_name, first_Name, last_name, enabled, date_created, last_modified ) values ( 'canvas@example.edu', 'Cavnas', 'Canvas', true, CURRENT_DATE(), CURRENT_DATE() );
insert into ACCOUNTS.account_setting(user_id, name, value, privacy) values (9, 'email', 'canvas@example.edu', 'public');
insert into ACCOUNTS.user_credentials (user_id, password, enabled, expires) values (9, '$2a$10$6REiiQD8i4FTE4D/X3.chOnlgxghwWMGcngksAjyQun0njGDQznxq', true, null);
insert into ACCOUNTS.user_organization_roles ( organization_id, user_id, role, date_created, audit_user_id ) values ( 1, 9, 'ADVISOR', CURRENT_DATE(), 0 );
