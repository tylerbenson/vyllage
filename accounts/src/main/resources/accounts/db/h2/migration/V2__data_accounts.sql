...
insert into ACCOUNTS.organization_roles ( organization_id, user_id, role ) values ( 0, 0, 'ADMIN' );
insert into ACCOUNTS.organization_roles ( organization_id, user_id, role ) values ( 0, 2, 'ADVISOR' );
insert into ACCOUNTS.organization_roles ( organization_id, user_id, role ) values ( 0, 3, 'STUDENT' );
insert into ACCOUNTS.organization_roles ( organization_id, user_id, role ) values ( 1, 1, 'ADMIN' );
insert into ACCOUNTS.organization_roles ( organization_id, user_id, role ) values ( 1, 2, 'STAFF' );
