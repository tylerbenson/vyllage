...
insert into ACCOUNTS.users ( user_name, first_Name, last_name, enabled, date_created, last_modified ) values ( 'carlos.uh@gmail.com', 'Carlos', 'Gagliardi', true, CURRENT_DATE(), CURRENT_DATE() );
...
insert into ACCOUNTS.account_setting(user_id, name, value, privacy) values (4, 'email', 'carlos.uh@gmail.com', 'public');
...
insert into ACCOUNTS.user_organization_roles ( organization_id, user_id, role, date_created, audit_user_id ) values ( 1, 4, 'ADMIN', CURRENT_DATE(), 0 );
insert into ACCOUNTS.user_organization_roles ( organization_id, user_id, role, date_created, audit_user_id ) values ( 0, 4, 'STAFF', CURRENT_DATE(), 0 );
