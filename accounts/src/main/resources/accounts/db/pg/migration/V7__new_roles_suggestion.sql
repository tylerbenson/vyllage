alter table ACCOUNTS.user_organization_roles drop constraint fk_user_organization_roles_role; 
...
alter table ACCOUNTS.user_organization_roles add constraint fk_user_organization_roles_role foreign key(role) references ACCOUNTS.roles(role);
