...
insert into accounts.users (user_id, user_name, first_Name, middle_name, last_name, enabled, date_created, last_modified) values (2, 'user@vyllage.com', 'Luke', 'V', 'Skywalker', true, CURRENT_DATE, CURRENT_DATE);
...
insert into accounts.user_organization_roles ( organization_id, user_id, role, date_created, audit_user_id ) values ( 0, 2, 'ADMIN', current_date, 0 );
