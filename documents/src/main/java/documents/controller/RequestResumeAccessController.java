...
public class RequestResumeAccessController {

	@SuppressWarnings("unused")
	private final Logger logger = Logger
			.getLogger(RequestResumeAccessController.class.getName());

	private final NotificationService notificationService;
	private final DocumentService documentService;

	@Inject
	public RequestResumeAccessController(
	...
	public void requestResumeAccess(@PathVariable final Long documentId,
