...
insert into documents.documents(document_id, user_id, visibility, tagline, date_created, last_modified) values(0, 0, true, 'My tagline.', CURRENT_DATE, CURRENT_DATE);
...
insert into documents.comments(comment_id, section_Id, section_Version, user_id, comment_Text, last_Modified) values(1, 126, 1, 0, 'Well played.', CURRENT_DATE);

insert into documents.suggestions(suggestion_id, section_Id, section_Version, user_id, json_Document, last_Modified) values (0, 124, 1, 0, '{
	"type": "freeform",
	"title": "career goal",
	"sectionId": 123,
	"sectionPosition": 1,
