        ...
        return (
            React.createElement("div", {className: "twelve columns"}, 
                React.createElement("div", null, 
                    React.createElement("button", {className: "article-btn"}, " ", this.props.freeformData.title, " ")
                ), 

                React.createElement(FreeformContainer, {freeformData: this.state.freeformData, saveChanges: this.saveChanges}), 
...
React.render(React.createElement(CareerGoalContainer, {freeformData: FreeFormData}), document.getElementById('career-goal-container'));