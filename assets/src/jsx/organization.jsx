...
var OrganizationCantainer = React.createClass({
    ...
    render: function() {
        return (
            <div className="twelve columns">
                <div>
                    <button className="article-btn"> {this.state.organizationData.type} </button>
                </div>
                <ArticleContent organizationData={this.state.organizationData} saveChanges={this.saveChanges} />
...
React.render(<OrganizationCantainer />, document.getElementById('experience-container'));
