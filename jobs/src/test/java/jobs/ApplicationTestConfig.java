...
import jobs.configuration.BeansConfiguration;
...
@ComponentScan(basePackages = { "jobs" }, excludeFilters = { @Filter(type = FilterType.ASSIGNABLE_TYPE, value = {
		BeansConfiguration.class, Application.class }) })
@PropertySource("classpath:/jobs/application-test.properties")
