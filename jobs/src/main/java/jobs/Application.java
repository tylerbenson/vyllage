...
@SpringBootApplication(scanBasePackages = { "jobs.configuration",
		"jobs.controller", "jobs.repository", "jobs.services" })
@PropertySource("classpath:/jobs/application-${profile}.properties")
