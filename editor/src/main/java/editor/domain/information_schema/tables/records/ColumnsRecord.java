...
public class ColumnsRecord extends org.jooq.impl.TableRecordImpl<editor.domain.information_schema.tables.records.ColumnsRecord> {

	private static final long serialVersionUID = -1159537871;
	...
	public ColumnsRecord() {
		super(editor.domain.information_schema.tables.Columns.COLUMNS);
	}
