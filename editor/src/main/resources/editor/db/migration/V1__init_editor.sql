...
insert into EDITOR.accounts(username) values('mario');
insert into EDITOR.accounts(username) values('pretendergod');
insert into EDITOR.accounts(username) values('link');
