...
insert into LOGIN.users ( username, password, enabled ) values ( 'deana@vyllage.com', '$2a$10$6REiiQD8i4FTE4D/X3.chOnlgxghwWMGcngksAjyQun0njGDQznxq', true );
insert into LOGIN.users ( username, password, enabled ) values ( 'someone@vyllage.com', '$2a$10$6REiiQD8i4FTE4D/X3.chOnlgxghwWMGcngksAjyQun0njGDQznxq', true );
